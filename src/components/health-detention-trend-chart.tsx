...
export function HealthDetentionTrendChart({ data }: Props) {
  return (
        ...
        <LineChart data={data} margin={{ top: 8, right: 12, bottom: 8, left: 4 }}>
          ...
          <Tooltip
            ...
            formatter={(value, name) => {
              ...
              return [formatRate(numericValue, 100_000), name];
            }}
          />
          <Legend />
          <Line
          ...
          <Line
            type="monotone"
            dataKey="otherBlackRate"
            name="Other Black"
            stroke={ETHNICITY_SERIES_COLORS.other_black}
            strokeWidth={2.5}
            dot={{ r: 2.5 }}
          />
        </LineChart>
